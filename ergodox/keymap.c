...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox(KC_EQUAL,KC_1,KC_2,KC_3,KC_4,KC_5,KC_LEFT,KC_TAB,KC_Q,KC_W,KC_E,KC_R,KC_T,TG(1),KC_BSPACE,KC_A,KC_S,KC_D,KC_F,KC_G,KC_LSHIFT,LCTL_T(KC_Z),KC_X,KC_C,KC_V,KC_B,KC_HYPR,KC_LCTRL,KC_GRAVE,KC_LALT,KC_LEFT,KC_RIGHT,KC_DELETE,KC_LGUI,KC_HOME,KC_SPACE,KC_BSPACE,KC_END,KC_F13,KC_6,KC_7,KC_8,KC_9,KC_0,KC_MINUS,TG(1),KC_Y,KC_U,KC_I,KC_O,KC_P,KC_BSLASH,KC_H,KC_J,KC_K,KC_L,LT(2,KC_SCOLON),LGUI_T(KC_QUOTE),KC_MEH,KC_N,KC_M,KC_COMMA,KC_DOT,RCTL_T(KC_SLASH),KC_RSHIFT,KC_UP,KC_DOWN,KC_LBRACKET,KC_RBRACKET,MO(1),KC_LALT,KC_ESCAPE,KC_PGUP,KC_PGDOWN,KC_TAB,KC_ENTER),
...
//   int16_t aX = analogRead(11);
  int16_t aY = analogRead(9);
//   print("\n");
//   print_dec(aX);
//   print("\t");
//   print_dec(aY);
