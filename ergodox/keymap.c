...
void pointing_device_task(void) {
  ...
  report.v = 0;
  report.buttons = 0;
//   int16_t aX = analogRead(9);
  int16_t aY = analogRead(11);
//   print("\n");
//   print_dec(aX);
//   print("\t");
//   print_dec(aY);
